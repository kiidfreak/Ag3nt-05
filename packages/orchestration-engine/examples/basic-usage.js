...
const OrchestrationEngine_1 = require("../src/core/OrchestrationEngine");
const factories_1 = require("../src/utils/factories");
const Workflow_1 = require("../src/types/Workflow");
async function basicUsageExample() {
    console.log('🚀 Starting Agent Labs Orchestration Engine Demo\n');
    // Initialize the orchestration engine
    const engine = new OrchestrationEngine_1.OrchestrationEngine();
    await engine.initialize();
    console.log('✅ Orchestration Engine initialized');
    // Create some sample agents
    const personalAssistantAgent = (0, factories_1.createAgent)('Personal Assistant', 'assistant', [
        {
    ...
    const emailAgent = (0, factories_1.createAgent)('Email Agent', 'email', [
        {
    ...
    // Create a workflow
    const workflow = (0, factories_1.createWorkflow)('Meeting Scheduler Workflow', 'Automatically schedule a meeting and send confirmation emails', {
        author: 'Agent Labs',
    ...
    const scheduleNode = (0, factories_1.createAgentTaskNode)('Schedule Meeting', personalAssistantAgent.id, 'schedule_meeting', { x: 100, y: 100 }, {
        title: '{{meetingTitle}}',
        date: '{{meetingDate}}',
        duration: 60
    });
    const emailNode = (0, factories_1.createAgentTaskNode)('Send Confirmation', emailAgent.id, 'send_notification', { x: 400, y: 100 }, {
    ...
    const edge = (0, factories_1.createWorkflowEdge)(scheduleNode.id, emailNode.id);
